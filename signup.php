   ...
   <body class="main-layout position_head">
      ...
      <div id="contact" class="contact">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <form id="request" class="main_form" method="post" action="register.php" enctype="multipart/form-data" >
                     <div class="row">
                        <div class="col-md-12 ">
                           <h3>Register</h3>
                        </div>
                        <?php 
                             ...
                             echo "<span class='bg-danger'><p class='text-center' style='color:white'>$_SESSION[status]</p></span>";
                        ...
                        <div class="col-md-12">
                           <button class="send_btn" name="signup">SignUp</button>
                        </div> 
                        <div class="col-md-12">
