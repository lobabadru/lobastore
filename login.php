   ...
   <body class="main-layout position_head">
      ...
      <div id="contact" class="contact">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <form id="request" class="main_form" action="register.php" method="post" enctype="multipart/form-data">
                     <div class="row">
                        <div class="col-md-12 ">
                           <h3>Contact Us</h3>
                        </div>
                        ...
                        <?php
                                ...
                                echo "<span class='bg-success'><p class='text-center' style='color:black'>$_SESSION[success]</p></span>";
                                unset($_SESSION['success']);
                            }
                            ?>
                      <?php
                          if(isset($_SESSION['status'])) {
                          echo "<span class='bg-danger'><p class='text-center' style='color:black'>$_SESSION[status]</p></span>";
                      ...
                      ?>
                        ...
                        <div class="col-md-12">
                           ...
                           <a href="signup.php" class="read_more">Signup Here</a>   
                        </div>
                     </div>
                  </form>
               </div>
